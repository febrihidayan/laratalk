    ...
    <transition name="zoom-out">
        <div v-show="isActive" class="fixed z-100 inset-0 overflow-y-auto">
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    :class="[`relative inline-block align-bottom bg-white dark:bg-dark-50 rounded-lg text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle w-full sm:max-w-lg`, {
                        'opacity-0': !isActive
                    }]"
                >
